...
function left_ai_calculate_ball_y() {
  ...
  let offset = getRandomInt(
    AI_ERROR_INITIAL - difficulty * AI_ERROR_TWEAK + ball.speed * AI_ERROR_TWEAK
  );
  //print (offset);
